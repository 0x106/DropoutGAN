...
class MNISTDataGenerator():
	...
	def __init__(self, opt):
		...
		self.trData, self.testData = validation_split(self.trData, 0.2)
		print(len(self.trData), len(self.testData))

		_, self.trData = validation_split(self.trData, 0.025)
		print(len(self.trData))

		# trData = []
		# idx = 0
		# for (data, target) in enumerate(self.trData):
		# 	if idx == 10000:
		# 		break
		# 	trData.append((data, target))
		# 	idx += 1
		#
		# self.trData = trData
